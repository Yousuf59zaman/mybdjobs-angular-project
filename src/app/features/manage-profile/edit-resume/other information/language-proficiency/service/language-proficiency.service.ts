...
import { deleteLanguage, insertLanguage, LanguageInfoResponse, LanguageQuery, LanguageResponse, updateLanguage } from '../model/language-proficiency';
...
export class LanguageProficiencyService {
  ...
  private readonly getApiUrl = 'https://jobseekerresumesubsystem-odcx6humqq-as.a.run.app/api/EditResume/GetLanguageProficiency';
  private readonly insertApi = 'https://jobseekerresumesubsystem-odcx6humqq-as.a.run.app/api/EditResume/InsertLanguage';
  private readonly updateApi = 'https://jobseekerresumesubsystem-odcx6humqq-as.a.run.app/api/EditResume/UpdateLanguage';
