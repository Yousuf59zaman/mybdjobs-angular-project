...
@Component({
  ...
  templateUrl: './appliedjobs-boost-success-modal.component.html',
  styleUrl: './appliedjobs-boost-success-modal.component.scss'
})
export class AppliedjobsBoostSuccessModalComponent {
   @Input() title: string = 'Success';
    @Input() description: string =
      'Information Updated succesfully';
    @Input() confirmText: string = 'Done';
    @Input() avatarSrc: string =
      'images/Icon wrapper.svg';
