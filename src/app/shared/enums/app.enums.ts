...
export enum Cookies {
  AUTH = 'ACCESSAUTHTOKEN',
  REFTOKEN = 'REFRESHTOKEN',
}

export const RecruiterPanelUrl = 'https://recruiter.bdjobs.com/';
export const mybdjobsWelcome = "https://mybdjobs.bdjobs.com/mybdjobs/welcome.asp"
export const mybdjobsEditProfile = "https://mybdjobs.bdjobs.com/new_mybdjobs/step_01_view.asp"
